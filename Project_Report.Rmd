...
labels <- c("Total Cases","Derivative of Total Cases", "Gaussian Curve")

#plot envelope
plot( L(x), type="l", lty=1, xlab="x value",
  ylab="Density", main="Comparison of functionS", col="blue")
#add plot for q
lines( DL(x), col="darkgreen")
#add plot for q
lines( N(x), col="purple")
...
- not able to gather data on movement restrictions and when they were put into place for each country
