...
MCEM GLMM MSE for prediction in all countries:
...
MSEs were calculated on a country by country bases for results with profet. Please note, the MSEs listed in the table below are for total number of cases and thus cannot be compared with the MSEs from the two methods reported previously. 
