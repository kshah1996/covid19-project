...
Clearly, the Poisson GLMM works much better for the US, South Korea, and China. For Italy, the random forest MSE is lower that the Poisson GLMM MSE, but keep in mind that random forest makes the same, flat prediction for Italy for every day of the future, as shown in the grahps above. Therefore, although the RF model happened to have decent predictions for Italy for the next few days, predictions would not hold up for dates further in the future.
...
MSEs were calculated on a country-by-country basis (for the next 8 days of predicton) with Prophet. Please note, the MSEs listed in the table below are for total number of cases and thus cannot be compared with the MSEs from the two methods reported previously. 
