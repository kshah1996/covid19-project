...
Italy <- forecast("Italy", dat, 5)
China <- forecast("China", dat, 10)
```

The logistic model is pretty bad when there is actual flattening of the curve, it wants to estimate higher (even when just fitting not predicting) - I think this is mainly due to the cap being MUCH higher than where the cases actually levelled off.
